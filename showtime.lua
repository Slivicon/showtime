...
function showtime.setDefaults()
  ...
  showtime.setParams(fontSize, showtime.getDefaultPosDynamic(), showtime.getDefaultPosX(), showtime.getDefaultPosY(fontSize), showtime.getDefaultTimeFormat24(), showtime.getDefaultShowSeconds());
end

function showtime.setParams(fontSize, posDynamic, posX, posY, timeFormat24, showSeconds)
